...
function Login() {
  ...
  return (
    <View style={tw`flex-1 justify-center items-center bg-black rounded  `}>
      <View
        style={tw`flex-1 justify-center items-center bg-yellow-500 p-4 rounded-[30px] m-5`}>
        <Text style={tw`text-5xl font-bold mb-10 text-blue-800`}>Belbit</Text>
        <Text style={tw`text-2xl font-bold  mb-5 text-blue-800`}>
        ...
        <TouchableOpacity
          ...
          style={tw` w-[360px] bg-blue-800 py-3 px-5 rounded-lg mb-4 mt-4`}>
        ...
        <TouchableOpacity
          ...
          <Text style={tw`text-lg text-black text-center`}>
            ...
            <Text style={tw`text-xl font-bold text-blue-800 text-center`}>
              Register
            </Text>
          </Text>
        </TouchableOpacity>
